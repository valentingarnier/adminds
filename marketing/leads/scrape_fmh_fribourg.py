"""
Scrape all psychiatrists in Fribourg from doctorfmh.ch and export to Excel.
...
Usage:
    ...
    python3 leads/scrape_fmh_fribourg.py
...
API_LIST = "/docapi/v1/docs/fr?certs1=39&canton=FR&practice=1&startrecord={offset}"
API_DETAIL = "/docapi/v1/doc/{link_id}/fr"
PAGE_SIZE = 24
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "psychiatrists_fribourg.xlsx")
CACHE_FILE = os.path.join(SCRIPT_DIR, "details_cache_fribourg.json")
